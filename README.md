...
`pnpm local:dev` now follows Vite's default localhost behavior again so VS Code port forwarding and remote-dev browser flows keep working. If you want LAN access instead, run `LOCAL_UI_HOST=0.0.0.0 pnpm local:dev`.
